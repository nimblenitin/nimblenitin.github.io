...
export default function ContactSection() {
	return (
		...
		>
			{/* Gradient overlay */}
			<div className="absolute inset-0 bg-gradient-to-b from-purple-100/80 to-white/40 pointer-events-none z-0" />
			<div className="relative z-10 max-w-3xl mx-auto text-center">
				...
				>
					<a
						href="mailto:naidunitin1@gmail.com"
				...
				>
					<a
						href="https://github.com/nimblenitin"
						target="_blank"
					...
					<a
						href="https://www.linkedin.com/in/nitin-naidu-236954354/"
						target="_blank"
						rel="noopener noreferrer"
						className="p-2 bg-gray-100 text-gray-800 rounded-full hover:bg-gray-200 transition-colors"
					>
					...
					<a
						href="https://medium.com/@nitinnaidu"
						target="_blank"
						rel="noopener noreferrer"
						className="p-2 bg-gray-100 text-gray-800 rounded-full hover:bg-gray-200 transition-colors"
					>
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
							<path d={simpleIcons.siMedium.path} />
						</svg>
					</a>
				</motion.div>
			</div>
